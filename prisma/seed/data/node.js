export const data = {
    ...
    questions: [
        ...
        },
        {
            ...
            answer: "File uploads in Express.js can be handled using middleware such as multer. Multer simplifies the process of handling multipart/form-data requests, allowing you to specify file upload settings like destination directory, file size limits, and file name formatting. After uploading files, you can process them further, such as storing them in a database or serving them to clients.",
        },
        {
            id: 16,
        ...
        },
        {
            ...
            answer: "Synchronous code execution blocks the execution thread until an operation completes, while asynchronous code execution allows the program to continue executing other tasks while waiting for an operation to finish. Asynchronous operations typically use callbacks, Promises, or async/await syntax to handle non-blocking I/O and concurrency.",
        },
        {
            id: 22,
        ...
        {
            id: 32,
            question: "Explain the concept of middleware error handling in Express.js.",
            answer: "Middleware error handling in Express.js involves defining error-handling middleware functions that are called when an error occurs during request processing. These middleware functions take four arguments (err, req, res, next) and can handle errors, log error messages, and send appropriate error responses to clients. Error-handling middleware should be placed at the end of the middleware chain to catch any errors that occur during request processing.",
        },
        {
            id: 33,
            question:
