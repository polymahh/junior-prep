...
export const teamsApi = {
    ...
    newTeamComment: async (teamId: string, commentDetails: string) => {
        const response = await axios.post(`api/teams/${teamId}`, commentDetails)
    ...
    updateTeamComment: async (teamId: string, commentId: string) => {
        const response = await axios.put(`api/teams/${teamId}/comment/${commentId}`)
        return await response.data
    },
